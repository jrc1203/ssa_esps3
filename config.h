...
const int ROOM_LDR_PINS[] = {
  PIN_LDR_ROOM1, PIN_LDR_ROOM2, PIN_LDR_ROOM3,
  PIN_LDR_ROOM4, PIN_LDR_ROOM5
};

// Quiz LDR pin array (indexed 0–2 for options A, B, C)
const int QUIZ_LDR_PINS[] = {
  PIN_LDR_QUIZ_A, PIN_LDR_QUIZ_B, PIN_LDR_QUIZ_C
};

// NeoPixel data pin array
const int NEO_PINS[] = {
  PIN_NEO1, PIN_NEO2, PIN_NEO3, PIN_NEO4, PIN_NEO5
};
